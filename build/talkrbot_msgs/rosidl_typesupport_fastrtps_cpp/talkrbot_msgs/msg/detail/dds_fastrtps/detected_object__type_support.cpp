...
#include "talkrbot_msgs/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const talkrbot_msgs::msg::DetectedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  talkrbot_msgs::msg::DetectedObject & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = talkrbot_msgs::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const talkrbot_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<talkrbot_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  return &talkrbot_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, talkrbot_msgs, msg, DetectedObject)() {
  return &talkrbot_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
