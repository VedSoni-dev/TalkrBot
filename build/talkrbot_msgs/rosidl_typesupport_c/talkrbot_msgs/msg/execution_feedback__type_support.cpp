...
static const _ExecutionFeedback_type_support_symbol_names_t _ExecutionFeedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, talkrbot_msgs, msg, ExecutionFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, talkrbot_msgs, msg, ExecutionFeedback)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, talkrbot_msgs, msg, ExecutionFeedback)() {
  return &::talkrbot_msgs::msg::rosidl_typesupport_c::ExecutionFeedback_message_type_support_handle;
}
