...
static const _RefinedIntent_type_support_symbol_names_t _RefinedIntent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, talkrbot_msgs, msg, RefinedIntent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, talkrbot_msgs, msg, RefinedIntent)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, talkrbot_msgs, msg, RefinedIntent)() {
  return &::talkrbot_msgs::msg::rosidl_typesupport_c::RefinedIntent_message_type_support_handle;
}
