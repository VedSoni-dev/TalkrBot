...
bool talkrbot_msgs__msg__aac_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("talkrbot_msgs.msg._aac_input.AACInput", full_classname_dest, 37) == 0);
  }
  talkrbot_msgs__msg__AACInput * ros_message = _ros_message;
  {  // text
  ...
  {  // input_method
    PyObject * field = PyObject_GetAttrString(_pymsg, "input_method");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->input_method, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // confidence
...
{
  /* NOTE(esteve): Call constructor of AACInput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("talkrbot_msgs.msg._aac_input");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AACInput");
  ...
  {  // input_method
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->input_method.data,
      strlen(ros_message->input_method.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "input_method", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
