...
bool talkrbot_msgs__msg__task_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("talkrbot_msgs.msg._task_command.TaskCommand", full_classname_dest, 43) == 0);
  }
  talkrbot_msgs__msg__TaskCommand * ros_message = _ros_message;
  {  // task
...
{
  /* NOTE(esteve): Call constructor of TaskCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("talkrbot_msgs.msg._task_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TaskCommand");
